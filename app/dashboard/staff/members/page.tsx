...
//     router.push(`/dashboard/user/subscription/${id}`);
//   };
...
//   return (
//     <div className="p-5">
//       <h1 className="text-2xl font-bold mb-4">Subscribed Members</h1>
//       <button
//         onClick={refetch}
...
//           {data.map((sub) => {
//             const userName = sub.user?.username || "Unknown User";
...
//               <Card
//                 key={sub._id}
//                 onClick={() => handleUserClick(sub._id)}
...
const MembersPage = () => {
  ...
  return (
    <div className="p-5">
      ...
      <button
        onClick={refetch}
        className="px-4 py-2 bg-blue-600 cursor-pointer text-white rounded mb-5"
      >
        Refresh
      </button>
