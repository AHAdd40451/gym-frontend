...
const BookingUserDetail = () => {
  ...
  useEffect(() => {
    const fetchUser = async () => {
      try {
        ...
        // ✅ Check if logged in user already bought this trainer
  ...
  // ✅ Buy Trainer Plan with Already Purchased Check
  ...
  try {
    ...
    // ✅ backend message is in res.error
    const backendMsg =
      res?.error ||
      res?.data?.message ||
      res?.message ||
